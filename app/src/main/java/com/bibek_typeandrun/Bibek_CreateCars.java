package com.bibek_typeandrun;

public class Bibek_CreateCars {

    private String make, year, color, price, engine, Answer;
    private int count;

    public Bibek_CreateCars(String make, String year, String color, String price, String engine, int count) {
        this.make = make;
        this.year = year;
        this.color = color;
        this.price = price;
